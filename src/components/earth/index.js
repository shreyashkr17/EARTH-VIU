...
export function Earth(props){
    ...
    return <>
        ...
        <pointLight color="#f6f3ea" position={[2, 0, 5]} intensity={1.6} />
        ...
        <mesh ref={earthRef} position={[0,0,3]}>
            ...
            {/* <OrbitControls enableRotate={true} enableZoom={true} enablePan={true} zoomSpeed={0.5} panSpeed={0.5} rotateSpeed={0.4}/> */}
        </mesh>
    </>
};